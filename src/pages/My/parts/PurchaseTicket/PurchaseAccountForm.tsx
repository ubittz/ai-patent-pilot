    ...
    <Flex.Vertical gap={30}>
      ...
      <StyledDescription>
        <Flex.Vertical className='description__top' gap={4}>
          <Typography.SmallSubtitle>가상계좌 입금 주의사항</Typography.SmallSubtitle>
          <Typography.SmallBody>계좌유효기간: 2024년 12월 02일 23시 03분 49초</Typography.SmallBody>
        </Flex.Vertical>
        <Flex.Vertical className='description__bottom' gap={8}>
          <Typography.SmallBody>- 가상계좌 주문 방식은 입금 최종 완료 후 주문확인 및 출고가 진행됩니다.</Typography.SmallBody>
          <Typography.SmallBody>- 가상계좌 입금 전 재고 소전, 상품 품절 판매 종료 등의 사유가 발생될 경우 주문이 취소됩니다.</Typography.SmallBody>
